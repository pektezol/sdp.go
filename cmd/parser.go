...
func getScoreboard(filePath string) (portalCount int32, tickCount int64, err error) {
			...
			for {
				...
				case 23:
					...
					case 60:
						...
						portalCount = scoreboardTempUpdate.NumPortals
						tickCount = int64(math.Round(float64((float32(scoreboardTempUpdate.TimeTaken) / 100.0) / float32(1.0/60.0))))
					}
				case 24:
